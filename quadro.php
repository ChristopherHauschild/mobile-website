...
<body>
	<div class="container">
		...
		<div class="quadro">
			...
			<button type="submit" name="comprar"><a href="https://christopherhauschild.github.io/mobile_website.github.io/carrinho.php?idProduto=<?php echo $produto['id']; ?>">  COMPRAR </a></button>
			</div>
